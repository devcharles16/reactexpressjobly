...
/* Set state for loading while waiting for API response and menu items 

function App() {
	const [ isLoading, setIsLoading ] = useState(true);
	const [ menuItems, setMenuItems ] = useState([]);

/* Get items from API and Set menu items as drinks or snacks accordingly 
	useEffect(() => {
...
/* Function to add/post items to file 
